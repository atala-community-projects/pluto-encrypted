const pkg = require("@atala/prism-wallet-sdk");
const InMemory = require("@pluto-encrypted/inmemory");
const Database = require("@pluto-encrypted/database").Database;

const { Apollo, ApiImpl, Castor, DIDCommWrapper, Mercury, PublicMediatorStore, BasicMediatorHandler, ConnectionsManager, Agent, Domain, ListenerKey } = pkg;
