...
import { getFromMapOrCreate, PROMISE_RESOLVE_FALSE, RxCollection, RXJS_SHARE_REPLAY_DEFAULTS, RxPlugin } from 'rxdb';
import { AllMigrationStates, RxDatabase, RxDocument } from 'rxdb/dist/types/types';
 ...
 */
export function mustMigrate(dataMigrator: EncryptedDataMigrator): Promise<boolean> {
...
export const DATA_MIGRATOR_BY_COLLECTION: WeakMap<RxCollection, EncryptedDataMigrator> = new WeakMap();
