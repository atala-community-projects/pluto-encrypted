...
[packages/database/src/schemas/CredentialRequestMetadata.ts:49](https://github.com/atala-community-projects/pluto-encrypted/blob/8af5bee/packages/database/src/schemas/CredentialRequestMetadata.ts#L49)
